...
export default {
    ...
    props: {
        ...
        //筛选类型 select:可选项选择 search:关键字搜索
        filterType: {
            type: String,
            default: "select",
            validator(val) {
                return /select|search/.test(val);
            }
        },
        ...
        filteredValue: Array,
        //数据过滤的选项，数组格式，数组中的元素需要有 text 和 value 属性。 为function时，参数为resolve函数，调用resolve函数将设置可选项
    ...
    created() {
        ...
        const defaults = {
            ...
            // filter 相关属性
            filterable: this.filters || this.filterMethod || ["search","dateSearch"].includes(this.filterType),
            filteredValue: [],
            filterPlacement: '',
            isColumnGroup: false,
            filterOpened: false,
        ...
        const basicProps = ['columnKey', 'prop', 'label', 'className', 'labelClassName', 'type', 'renderHeader', 'formatter', 'fixed', 'resizable'];
        const sortProps = ['sortMethod', 'sortBy', 'sortOrders'];
        const selectProps = ['selectable', 'reserveSelection'];
        const filterProps = ['filterType', 'filterMethod', 'filters', 'filterMultiple', 'filterOpened', 'filteredValue', 'filterPlacement'];
