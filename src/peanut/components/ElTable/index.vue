<template>
    <div class="el-table"
        ...
        <div
            ...
            :style="[bodyHeight]">
            <div ref="bodyWrapper" :style="bodyWrapperStyle">
                <table-body
                    :context="context"
                    :store="store"
                    :stripe="stripe"
            ...
            <table-scrollbar direction="vertical"/>
            <table-scrollbar direction="horizontal"/>
        </div>
        <div
            v-if="showSummary"
        ...
        <div
            ...
            :style="[{width: layout.rightFixedWidth ? layout.rightFixedWidth + 'px' : '', right: layout.scrollY ? (border ? layout.gutterWidth : (layout.gutterWidth || 0)) + 'px' : ''}, fixedHeight]">
            <div v-if="showHeader"
                 class="el-table__fixed-header-wrapper"
...
export default {
    ...
    props: {
        ...
        //筛选模式 local:本地数据筛选 remote:远程数据筛选
        filterMode: {
            type: String,
            default: "local",
            validator(val) {
                return /local|remote/.test(val)
            }
        },
        lazy: Boolean,
        load: Function
    ...
    methods: {
        ...
        handleHeaderFooterMousewheel(event, data) {
            ...
            if (Math.abs(pixelX) >= Math.abs(pixelY)) {
                this.bodyWrapper.scrollLeft += data.pixelX;
            }
        },
